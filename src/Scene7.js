                ...
                <Timeline
                    ...
                    target={
                        <Fragment>
                            ...
                            <img src="./screens/OneEdu/4.png" alt="calendar screen" className="oven-screenshot" style={{ top: '10vh' }} /><br />
                            <img src="./screens/OneEdu/3.png" alt="schedule screen" className="oven-screenshot" style={{ top: '-15vh', left: '22vw' }} />
                            <img src="./screens/OneEdu/5.png" alt="courses screen" className="oven-screenshot" style={{ top: '-60vh', left: '56vw' }} /><br />
                            <img src="./screens/OneEdu/6.png" alt="extra screen" className="oven-screenshot" style={{ top: '-105vh', left: '55vw' }} /><br />
                            <img src="./screens/OneEdu/7.png" alt="news screen" className="oven-screenshot" style={{ top: '-174vh', left: '98vw' }} /><br />
                            <img src="./screens/OneEdu/9.png" alt="profile screen" className="oven-screenshot" style={{ top: '-264vh', left: '-14vw' }} />
                            <br />
                            <div className="slide-6-statement">And a groundbreaking<br />Educational Platform.</div>
                            <div className="para" style={{ position: 'absolute', top: '98vh', left: '35vw', textAlign: 'center', width: '56vw', paddingLeft: '22vw', paddingRight: '22vw' }}>
                                A scalable end-to-end cloud solution for educational administration, including full-fledged cross-platform mobile apps for students, educators, and institutions.
                                <br /><br />
