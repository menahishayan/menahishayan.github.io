      ...
      <ScrollTrigger start="150px center" end="2500px center" scrub={0.7}>
        <Timeline
          target={
            <Fragment>
              ...
              <div
                style={{
                  background: "radial-gradient(farthest-corner at 17vw 40vh, rgba(239,194,132,1) 0%, rgba(71,68,58,0) 60%)",
                  height: "100vh",
                  width: "100vh",
                  zIndex: -9,
                  position: "absolute",
              ...
              <div className="slide-3-pretext" style={{ textAlign: "left", marginLeft: "35vw", marginBottom: "0", color: "#555" }}>
                or...
                <br />
                <br />
                <br />
              </div>
              <div className="slide-3-statement" style={{ textAlign: "left", marginLeft: "35vw", fontSize: 70 }}>
                Building A Popular
                <br />
                Home Automation API
              </div>
              ...
              <div
                ...
                style={{ textAlign: "center", fontSize: 70, position: "absolute", top: "22vh", width: "100vw", color: "wheat", paddingLeft: "3vw" }}
              >
                HomeScript
              </div>
              <div
                className="para"
                style={{ position: "absolute", top: "35vh", left: 0, textAlign: "center", width: "100vw", color: "lightgray", fontWeight: "bold" }}
              >
                Your home just got an API.
              </div>
              <div
                className="para"
                style={{
              ...
              >
                HomeScript is a robust API that allows command-line control of your smart home accessories. This popular script serves as the
                underlying framework to run home automations and opens your home to a world of scripting capabilites!
                <br />
                <br />
                With command-line controls, a fully importable API, group functions, intelligent support for loosely-typed commands and EasyMatch
                referencing, HomeScript is the simplest and most robust way of automating your HomeKit installation!
              </div>
              <div
                style={{
                  position: "absolute",
        ...
        >
          ...
          <Timeline
            target={
              <Fragment>
                <SplitChars wrapper={<span className="slide-5-code" style={{ color: "rgba(255,206,252,0.4)" }} />}>.set('light',#efc385)</SplitChars>
              </Fragment>
            }
            labels={Array(30).map((_, a) => {
              return { label: a + "", position: a };
          ...
          <Tween
            to={{ delay: 0.8, x: "-5vw", y: "30vh", transform: "scale(0.3)", opacity: 0 }}
            target={2}
            position="15"
            ease="elastic.out(0.1, 0.2)"
          />
          <Tween
            to={{ delay: 1.2, x: "-45vw", y: "55vh", transform: "scale(0.2)", opacity: 0 }}
            target={4}
            position="15"
            ease="elastic.out(0.1, 0.2)"
          />
          <Tween
            to={{ delay: 1, x: "-48vw", y: "35vh", transform: "scale(0.1)", opacity: 0 }}
            target={5}
            position="15"
            ease="elastic.out(0.1, 0.2)"
          />
          ...
          <Tween
            from={{ x: "-5vw", y: 0, transform: "rotate(20deg)" }}
            to={{ x: "18vw", y: "-60vh", transform: "rotate(0deg)" }}
            target={6}
            position="17"
            ease="back.out(1.5)"
          />
