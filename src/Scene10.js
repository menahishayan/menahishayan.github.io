                ...
                <Timeline
                    target={
                        <Fragment>
                            ...
                            <div className="card">
                                <img className="profile-pic" src={dp} />
                                <div className="card-right-subcontainer">
                                    <div className="para" style={{ fontSize: 26, fontWeight: 700, color: 'black', marginTop: 20, lineHeight: '4vh' }}>Menahi Shayan</div>
                                    <div className="para" style={{ fontSize: 20, lineHeight: '3vh', marginTop: 3 }}>menahi.shayan@gmail.com<br />+91 89717 29383</div>
                                </div>
                            </div>
