...
const Scene10 = () => {
  useEffect(() => {
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))
      window.alert("Mobile version is currently under development. It is recommended that you view it on desktop.");
  }, []);
  return (
    <Scene pin>
              ...
              <Fragment>
                ...
                <div className="card">
                  ...
                  <div className="card-right-subcontainer">
                    <div className="para selectable" style={{ fontSize: 26, fontWeight: 700, color: "black", marginTop: 20, lineHeight: "4vh" }}>
                      Menahi Shayan
                    </div>
                    <div className="para selectable" style={{ fontSize: 20, lineHeight: "3vh", marginTop: 3 }}>
                      menahi.shayan@gmail.com
                      <br />
                      +91 89717 29383
                    </div>
                  </div>
                </div>
                <div className="slide-10-statement" style={{ fontSize: 24, fontWeight: 700, top: "35vh" }}>
                  Find Me On
                </div>
                <div style={{ flexDirection: "row", display: "flex", position: "relative", top: "35vh", paddingLeft: "42vw", paddingRight: "42vw" }}>
                  <div className="link-badge-container">
                    <img
                      ...
                      alt="linkedin"
                      onClick={() => (window.location.href = "https://www.linkedin.com/in/menahi-shayan/")}
                    />
                  </div>
                  <div className="link-badge-container">
                    <img
                      ...
                      className="link-badge"
                      alt="github"
                      onClick={() => (window.location.href = "https://github.com/menahishayan")}
                    />
                  </div>
                </div>
                <div
                  className="read-more"
                  style={{ color: "#777", position: "relative", top: "38vh", left: 10, fontSize: 18 }}
