...
const HalfSplitSentence = forwardRef((props, ref) => {
  ...
  return (
    <div ref={wrapper}>
      <div className="slide-3-statement" ref={first} style={{ display: "inline-block", textAlign: "left", position: "relative", top: "-110vh" }}>
        {props.first}&nbsp;
      </div>
      <div className="slide-3-statement" ref={last} style={{ display: "inline-block", textAlign: "left", position: "relative", top: "-110vh" }}>
        {props.last}
      </div>
    </div>
  );
});
HalfSplitSentence.displayName = "HalfSplitSentence";
    ...
    <section className="slide-3">
      ...
      <ScrollTrigger start="240vh center" end="1000vh center" scrub={0.3}>
            ...
            <Fragment>
              ...
              <div>
                ...
                <div className="para" style={{ width: "30vw", fontSize: "2.5vh" }}>
                  <br />
                  <br />
                  A one of a kind retrofitted feat of engineering, this oven uses IoT sensors and on-device machine learning to identify the food you
                  place and automatically set the time and temperature.
                  <br />
                  <br />
                  All you have to do is place the item in. It&apos;s that simple.
                  <br />
                  <br />
                  Combined with an elegant UI, rich notifications, recipe comprehension, smart home integration, real-time energy analytics and an
                  open API, the Automated Oven is truly the biggest upgrade to the oven since it was invented.
                </div>
                <br />
                <br />
                <br />
              </div>
              <div style={{ flexDirection: "row", display: "flex" }}>{techBadges(["IoT", "TensorFlow", "Websockets", "Python", "Linux"])}</div>
              <div
                style={{
                  background: "linear-gradient(0deg, rgba(141,193,253,1) 0%, rgba(216,227,244,1) 100%)",
                  height: "100vh",
                  width: "100vw",
                  zIndex: -10,
                  position: "fixed",
        ...
        >
          ...
          >
            <Tween
              from={{ x: "18vw", transform: "scale(8)", opacity: 0 }}
              target="first"
              to={{ x: "18vw", transform: "scale(1)", opacity: 1 }}
              ease="elastic.out(0.2,1.2)"
              position="0"
            />
